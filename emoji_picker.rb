...
😏 :smirk: smirking face
😁 :grin: beaming face with smiling eyes :D
...
😄 :smile: grinning face with smiling eyes :D
...
📷 :camera: camera
🌹 :rose: rose
😝 :stuck_out_tongue_closed_eyes: squinting face with tongue :P
...
😆 :laughing: grinning squinting face :D
...
😛 :stuck_out_tongue: face with tongue :P
😥 :disappointed_relieved: sad but relieved face ;(
😇 :innocent: smiling face with halo, angel, O:)
...
⚓ :anchor: anchor
⚡ :zap: high voltage
✖️ :heavy_multiplication_x: multiplication sign
...
ℹ :information_source: information
🐂 :ox: ox
🍙 :rice_ball: rice ball
🆚 :vs: VS button
🔚 :end: END arrow
...
🤖 :robot: robot
🤕 :face_with_headbandage: face with head-bandage
🤔 :thinking: thinking face
🤓 :nerd: nerd face
🤒 :face_with_thermometer: face with thermometer
🤑 :moneymouth_face: money-mouth face
...
👁 :eye: eye
🏋 :weightlifter: person lifting weights
⛹ :basketballer: person bouncing ball
🕴 :man_in_suit: man in suit levitating
...
🛢 :oil_drum: oil drum
🛡 :shield: shield
🛠 :hammer_and_wrench: hammer and wrench tools
🛏 :bed: bed
...
🗡 :dagger: dagger
🗞 :rolledup_newspaper: rolled-up newspaper
🗝 :old_key: old key
🗜 :compression: clamp
...
🏕 :camping: camping
🏔 :snowcapped_mountain: snow-capped mountain
...
⛑ :rescue_worker’s_helmet: rescue worker’s helmet
...
8⃣ :eight: keycap: 8
9⃣ :nine: keycap: 9
🤣 :rolling_on_the_floor_laughing: rolling on the floor laughing rofl
...
🤟 :loveyou_gesture: love-you gesture
🤙 :call_me_hand: call me hand
☝ :index_pointing_up: index pointing up
🤛 :leftfacing_fist: left-facing fist
🤜 :rightfacing_fist: right-facing fist
...
🏼 :mediumlight_skin_tone: medium-light skin tone
🏽 :medium_skin_tone: medium skin tone
🏾 :mediumdark_skin_tone: medium-dark skin tone
...
🧦 :socks: socks
🥻 :sari: sari
🩱 :onepiece_swimsuit: one-piece swimsuit
🩲 :briefs: briefs
🩳 :shorts: shorts
...
⚠ :warning: warning
⬆ :up_arrow: up arrow
↗ :upright_arrow: up-right arrow
↘ :downright_arrow: down-right arrow
⬇ :down_arrow: down arrow
↙ :downleft_arrow: down-left arrow
...
✳ :eightspoked_asterisk: eight-spoked asterisk
✴ :eightpointed_star: eight-pointed star
❇ :sparkle: sparkle
